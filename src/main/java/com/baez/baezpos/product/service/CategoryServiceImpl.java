...
public class CategoryServiceImpl implements CategoryService {
    ...
    public CategoryResponseDTO createCategory(CategoryRequestDTO dto) {
        ...
        categoryRepository.findByNameAndCompanyId(categoryName, companyId).ifPresent(c -> {
            if (c.getActive()) {
                throw new BadRequestException("Ya existe una categorÃ­a activa con el nombre '" + categoryName + "'");
            }
        });
        ...
        auditService.logAction("CREACION_CATEGORIA", "CategorÃ­a creada: " + saved.getName(), "INFO");
    ...
    public CategoryResponseDTO getCategoryById(Long id) {
        ...
        Category category = categoryRepository.findByIdAndCompanyId(id, companyId)
                .orElseThrow(() -> new ResourceNotFoundException("CategorÃ­a no encontrada en su empresa"));
    ...
    public CategoryResponseDTO updateCategory(Long id, CategoryRequestDTO dto) {
        ...
        auditService.logAction("ACTUALIZACION_CATEGORIA", "CategorÃ­a actualizada ID: " + id, "INFO");
    ...
    public void deleteCategory(Long id) {
        ...
        auditService.logAction("ELIMINACION_CATEGORIA", "CategorÃ­a desactivada: " + category.getName(), "WARN");
    }
    ...
    public CategoryResponseDTO activateCategory(Long id) {
        ...
        auditService.logAction("ACTIVACION_CATEGORIA", "CategorÃ­a reactivada: " + category.getName(), "INFO");
    ...
    private Long requireCompanyContext() {
        ...
        if (companyId == null) {
            throw new BadRequestException("Acceso denegado: OperaciÃ³n requiere un contexto de empresa vÃ¡lido.");
        }
        return companyId;
    }

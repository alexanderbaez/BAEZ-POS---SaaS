-- ==============================================================================
-- MIGRACIÃ“N DE ÃNDICES DE RENDIMIENTO (BAEZ POS SaaS)
-- Ejecutar este script en Aiven (MySQL) antes o despuÃ©s de desplegar a Render.
-- ==============================================================================
...
-- 2. Tabla companies: Acelera bÃºsquedas de validaciÃ³n de inquilino y tax_id
CREATE INDEX idx_companies_active ON companies (active);
CREATE INDEX idx_companies_tax_id ON companies (tax_id);

-- 3. Tabla sales: Aisla la bÃºsqueda de Nro. de Comprobante por tenant
-- Nota: Si idx_sales_nro_comprobante ya existÃ­a, considerar hacer DROP INDEX idx_sales_nro_comprobante ON sales;
CREATE INDEX idx_sales_company_nro_comprobante ON sales (company_id, nro_comprobante);

-- 4. Tabla expenses: Acelera los reportes de flujo de caja y filtrado por mÃ©todo de pago

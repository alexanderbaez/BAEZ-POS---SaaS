...
public interface SaleRepository extends JpaRepository<Sale, Long> {
    ...
    /**
     * CRIT-02: Filtro de companyId aÃ±adido como defensa de segunda lÃ­nea.
     ...
     * Retorna (sessionId, paymentMethod, SUM(total)) agrupado â€” un solo viaje a la BD
     * en lugar de 1 SELECT * por cada sesiÃ³n de la jornada.
     */
    ...
    /**
     * AgregaciÃ³n masiva de costo de reposiciÃ³n: calcula SUM(item.cost * item.quantity)
    ...
    /**
     * AgregaciÃ³n por mÃ©todo de pago para rangos de auditorÃ­a de caja.
     */
